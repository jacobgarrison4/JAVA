public class RBT<E extends Comparable<E>> {
    ...
    public void insert(E data){
        ...
        val.setLeftChild(nil);
        val.setRightChild(nil);
        val.setColor('R');
        InsertColorFix(val);
    }
    ...
    public Node<E> search(E data){
        ...
        while ((current != nil) && (value.compareTo(data) != 0)){
    ...
    public boolean isRBT(Node<E> x){
        //root must be black
        if(x.getColor() == 'B'){
            return true;
        }
        //all nodes must be red or black
        if(RedBlackNodes(x) == true){
            return true;
        }
    ...
    public boolean RedBlackNodes(Node<E> x){
        if(x != null){
            if((x.getColor() == 'B') || (x.getColor() == 'R')){
                return true;
            }
            return (RedBlackNodes(x.getRightChild()) && RedBlackNodes(x.getLeftChild()));
        }
        return false;
    }

    public boolean RedFamily(Node<E> x){
        if(x != null){
            if(x.getColor() == 'R'){
                if(((x.getLeftChild() != null) && (x.getLeftChild().getColor() == 'B')) || 
                    ((x.getRightChild() != null) && (x.getRightChild().getColor() =='B'))){
                    return true;
                }
                return false;
            }
            return (RedFamily(x.getRightChild()) && RedFamily(x.getLeftChild()));
        }
        return false;
    }
}